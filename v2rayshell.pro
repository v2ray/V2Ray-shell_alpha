SOURCES += ./src/bridgehouse/bridge.py \
		./src/bridgehouse/extension/bridgePreference.py \
		./src/bridgehouse/extension/bridgetreasureChest.py \
		./src/bridgehouse/extension/proxyTest.py \
		./src/bridgehouse/extension/runV2raycore.py \
		./src/bridgehouse/extension/updatePanel.py \
		./src/bridgehouse/extension/bugReport.py \
		./src/bridgehouse/editMap/cafeteriaTAB.py \
		./src/bridgehouse/editMap/dnsTAB.py \
		...
		./src/bridgehouse/editMap/port/inboundPanel.py \
		./src/bridgehouse/editMap/port/openV2rayJSONFile.py \
